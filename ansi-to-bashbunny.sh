...
TABLE=$(mktemp)
function setupTable() { # This is a table of ASCII+extended characters
	echo "☺ 1 0x01
	☻ 2 0x02
	♥ 3 0x03
	♦ 4 0x04
...
cat $1 | while read -n 1 char; do # This will cat out the file and read it one line at a time
	...
	grep "$char" $TABLE | awk {'print $2'} # This finds the correct altcode as long as it is not 0 or 255
...
rm $TABLE # Clean up the temp file we made
